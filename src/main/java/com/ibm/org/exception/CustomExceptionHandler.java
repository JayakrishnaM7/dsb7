...
public class CustomExceptionHandler {
	...
	//#AutowireServices
	@Autowired
	private V1Bian3CorePayment1000InitpaymentPostI v1Bian3CorePayment1000InitpaymentPostI;
	@Autowired
	private V1Bian3CorePayment1000UpdatepaymentPutI v1Bian3CorePayment1000UpdatepaymentPutI;
	...
	private Object getErrorObject(String operationId,ErrorStatusCode code,Exception exception){
		...
		if(apiExceptionResponse != null) {
			try {
				switch(operationId){
			case "v1Bian3CorePayment1000InitpaymentPost":
			object = v1Bian3CorePayment1000InitpaymentPostI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
			
			case "v1Bian3CorePayment1000UpdatepaymentPut":
			object = v1Bian3CorePayment1000UpdatepaymentPutI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
